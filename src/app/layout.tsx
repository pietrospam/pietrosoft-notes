...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {isTest && (
          <div className="fixed top-0 left-0 right-0 z-50 bg-emerald-900 text-white text-xs font-bold text-center py-1 tracking-widest uppercase shadow-lg shadow-emerald-500/20">
